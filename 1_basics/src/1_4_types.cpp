...
size_of_type() {
    ...
    cout << "size of complex<double>: " << sizeof(complex<double>) << " bytes" << endl;
}
...
print_num() {
    ...
    const double i2{ 0b1010'1010 }; // 二进制 (170)，使用单引号作为数字分隔符 (C++14)
...
initialization_list() {
    ...
    /* {} 方式不接受隐式类型转换 */
    //int i2{ 7.8 }; /* 错误：narrowing conversion of ‘7.7999999999999998e+0’ from ‘double’ to ‘int’ [-Wnarrowing] */
