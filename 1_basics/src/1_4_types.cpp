...
namespace ch1_types_impl {
     ...
     * Initialization）语法，以及它如何通过禁止窄化转换来提高代码安全性。 被
     * @ref tutorial_types 调用。
     */
    void
    initialization_list() {
        double          d1{ 2.3 };
        ...
        /* {} 方式不接受隐式类型转换 */
        // int i2{ 7.8 }; /* 错误：narrowing conversion of
        // ‘7.7999999999999998e+0’ from ‘double’ to ‘int’ [-Wnarrowing] */
...
void
tutorial_types() {
    using namespace ch1_types_impl;
